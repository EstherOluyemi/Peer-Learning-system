          ...
          <div className="w-full max-w-md space-y-6 sm:space-y-8">
            ...
            <header>
              ...
              <div className="flex items-center gap-3 mb-6">
                <img src={peerlearnLogo} alt="PeerLearn Logo" className="w-10 h-10 object-contain" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6" id="login-form" noValidate>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleChange}
                    className="h-4 w-4 rounded border-slate-300 text-blue-700 dark:text-blue-500 focus:ring-blue-500 cursor-pointer"
                    disabled={isLoading}
                  />
                ...
                <Link to="/forgot-password" className="text-sm font-medium text-blue-700 dark:text-blue-500 hover:text-blue-800 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 rounded">
                  Forgot password?
                </Link>
              </div>
              ...
              <p className="text-center text-sm text-slate-600 dark:text-slate-500 dark:text-slate-400 pt-2">
                ...
                <Link
                  to="/signup"
                  className="font-semibold text-blue-700 dark:text-blue-500 hover:text-blue-700 hover:underline transition-all"
                >
                  Create an account
                </Link>
              </p>
