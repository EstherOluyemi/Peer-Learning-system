      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-4xl">
        ...
        <header className="mb-6 sm:mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <button
               ...
               className="inline-flex items-center text-slate-500 dark:text-slate-500 dark:text-slate-300 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400 font-medium transition-colors mb-6 group focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 rounded"
            >
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900/50 border border-transparent dark:border-slate-700 p-8 sm:p-12 text-center transition-colors">
            ...
            <p className="text-slate-600 dark:text-slate-500 dark:text-slate-300 mb-6">Create your first tutoring session to get started!</p>
            <button
              onClick={() => navigate('/create-session')}
              ...
              <div
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 dark:text-slate-500 dark:text-slate-300 mb-3">{session.subject || 'No subject'}</p>
