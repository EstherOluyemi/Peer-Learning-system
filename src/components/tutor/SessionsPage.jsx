          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border-none rounded-full text-sm focus:outline-none transition-all placeholder:text-slate-500 dark:placeholder:text-slate-400"
                style={{
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-slate-600 dark:text-slate-500 dark:text-slate-400">{quickStats.completed}</span>
              </div>
              <div className="flex justify-between items-center">
