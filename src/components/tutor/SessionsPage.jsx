...
const SessionsPage = () => {
  ...
  const getStatusColor = (status) => {
    const statusMap = {
      'scheduled': 'bg--100 text--800 dark:bg-blue-900/30 dark:text-blue-400 border-blue-200 dark:border-blue-800',
      'ongoing': 'bg--100 text--800 dark:bg-emerald-900/30 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800',
      'completed': 'bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-600',
      'cancelled': 'bg--100 text--800 dark:bg-red-900/30 dark:text-red-400 border-red-200 dark:border-red-800'
    };
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border-none rounded-full text-sm focus:outline-none transition-all placeholder:text-slate-500 dark:placeholder:text-slate-500"
                style={{
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex flex-col sm:flex-row sm:items-start gap-4 flex-1">
                        <div className="flex flex-col items-center justify-center w-20 h-20 bg-blue-50 dark:bg-blue-900/20 rounded-xl text-blue-700 dark:text-blue-500 shrink-0">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-sm" style={{ color: 'var(--text-tertiary)' }}>
                            ...
                            {session.meetingLink && (
                              <span className="flex items-center gap-1 text-blue-700 dark:text-blue-500"><Video className="w-3.5 h-3.5" aria-hidden="true" /> Video call</span>
                            )}
                          </div>
                        </div>
                      </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-slate-600 dark:text-slate-500 dark:text-slate-300">{quickStats.completed}</span>
              </div>
              <div className="flex justify-between items-center">
                <span style={{ color: 'var(--text-secondary)' }}>Scheduled</span>
                <span className="font-bold text-blue-700 dark:text-blue-500">{quickStats.scheduled}</span>
              </div>
            </div>
          </div>
