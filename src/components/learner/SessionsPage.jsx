...
const SessionsPage = () => {
    ...
    const upcomingToday = sessions
        .filter((session) => {
            ...
            return isToday(session.startTime) && status !== 'completed' && status !== 'cancelled';
        })
                    ...
                    {upcomingToday.length > 0 && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <h2 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Upcoming Today</h2>
                                    <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Your sessions scheduled for today.</p>
                                </div>
                                <button
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>{start.time} • {session.subject || 'General'}</div>
                                                </div>
                                            </div>
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-bold" style={{ color: 'var(--text-primary)' }}>{sessions.length}</span>
                            </div>
                            <div className="flex justify-between items-center">
