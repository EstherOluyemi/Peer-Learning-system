      ...
      <div className="rounded-2xl shadow-sm border p-6" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--card-border)' }}>
        ...
        {completedSessions.length > 0 ? (
                ...
                >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-sm shrink-0 transition-colors ${alreadyRated
                        ? 'bg-slate-100 text-slate-500 dark:text-slate-300 cursor-not-allowed dark:bg-slate-800 dark:text-slate-500'
          ...
          <div className="p-8 text-center" aria-live="polite">
            <MessageSquare className="w-12 h-12 text-slate-500 dark:text-slate-300 mx-auto mb-3" aria-hidden="true" />
        ...
        <div className="divide-y" style={{ borderColor: 'var(--border-color)' }}>
          {ratedSessions.length > 0 ? (
            ...
            <div className="p-12 text-center" aria-live="polite">
              <Star className="w-12 h-12 text-slate-500 dark:text-slate-300 mx-auto mb-3" aria-hidden="true" />
